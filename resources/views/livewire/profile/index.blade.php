...
<div>
    <div class="datos">
        ...
        <div class="card">
            ...
            <div class="part2">
                <div>
                    <h3 id="nombre-completo">{{ $profile->name }}</h3>
                ...
                <div class="estado2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="11" height="14" viewBox="0 0 11 14" fill="none">
                        ...
                        <rect y="5" width="11" height="9" rx="1.5" stroke="#78B548" stroke-width="3.2" mask="url(#path-1-inside-1_596_506)" />
    ...
    <div class="itemInfo">
        ...
        <div class="cuerpo">
            <div class="contentInput">
                <p>Deportivas</p>
                <input type="text" name="centro_estudio" id="centro_estudio" value="Fútbol, Natación, Tenis" disabled />
            </div>
            <div class="contentInput">
                <p>Actividades Recreativas</p>
                <input type="text" name="especialidad" id="especialidad" value="Zumba, Full Body, Stretching" disabled />
            </div>
            <div class="contentInput">
                <p>Actividades Culturales</p>
                <input type="text" name="profesion" id="profesion" value="Exposiciones de arte, Cine, Fotografía, Gastron..." disabled />
            </div>
            <div class="contentInput">
