...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/style-participacion.css" />
  ...
  <body>
    ...
    <x-barra-lateral />
      ...
      <main>
      <x-cabecera-top />
        <div class="title">Participacion</div>
        <div class="subtitle">Accede a tus documentos</div>
        <div class="contentEnlaces">
          <div class="contentItem">
            <div class="item">
              <a href="{{ route('archivo-digital') }}">
                <img src="imgs/icon_archivodigital.svg" alt="" />
                <p>Archivo Digital</p>
              </a>
            </div>
          ...
          <div class="contentItem">
            <div class="item">
              <a href="#">
                <img src="imgs/icon_encuestavirtuales.svg" alt="" />
                <p>Encuesta Virtuales</p>
              </a>
            </div>
            <div class="item">
              <a href="{{ route('votacion-electronica') }}">
                <img src="imgs/icon_votacionelectronica.svg" alt="" />
                <p>Votacion Electronica</p>
              </a>
            </div>
          </div>
        </div>
        <a href="#" class="btnAtras">Atras</a>
      </main>
    </div>
