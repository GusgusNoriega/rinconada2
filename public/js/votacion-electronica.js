document.addEventListener("DOMContentLoaded", function () {
  ...
  let activeItem = null; // Guarda el item activo para actualizar su altura dinÃ¡micamente

  // FunciÃ³n para actualizar la altura de .contentInfo
  ...
  // Manejo de selecciÃ³n de listas
  botones.forEach((button) => {
    button.addEventListener("click", function () {
      ...
      // Activar el botÃ³n 'registrar' si hay un item seleccionado
  ...
  // Escuchar cambios de tamaÃ±o de ventana para actualizar la altura de contentInfo
  ...
  // Cerrar la modal cuando se hace clic en el botÃ³n 'close'
